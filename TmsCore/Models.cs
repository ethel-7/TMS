...
// ============================================================================
// CUSTOM EXCEPTIONS - Domain-specific error handling (Session 3)
// ============================================================================

/// <summary>
/// Custom exception for database-related failures in the TMS
/// Wraps infrastructure exceptions with domain context for better logging and debugging
/// </summary>
public class TmsDatabaseException : Exception
{
    /// <summary>
    /// The database operation that failed (e.g., "FetchStudent", "SaveEnrollment")
    /// </summary>
    public string Operation { get; }

    /// <summary>
    /// Creates a new TmsDatabaseException with operation context
    /// </summary>
    ...
    /// <summary>
    /// Creates a new TmsDatabaseException wrapping an inner exception
    /// Always use this constructor when catching infrastructure exceptions
    /// </summary>
    /// <param name="operation">The operation that failed</param>
    /// <param name="message">Human-readable error message</param>
    /// <param name="innerException">The original exception from the database layer</param>
...
/// <summary>
/// Custom exception thrown when a course reaches maximum enrollment capacity
/// Provides domain-specific context (course code) for better error handling
/// Inherits from InvalidOperationException to maintain compatibility with existing catch blocks
/// </summary>
public class CapacityReachedException : InvalidOperationException
{
    /// <summary>
    /// The course code that has reached capacity
    /// </summary>
    public string CourseCode { get; }

    /// <summary>
    /// Creates a new CapacityReachedException for a specific course
    /// </summary>
    /// <param name="courseCode">The course that is full</param>
    ...
    /// <summary>
    /// Creates a new CapacityReachedException wrapping an inner exception
    /// </summary>
    /// <param name="courseCode">The course that is full</param>
